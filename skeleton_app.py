"""
FLASK CRUD APPLICATION SKELETON
===============================

This is a skeleton Flask application for CRUD operations.
Students should complete the TODO sections marked with comments.

Database Model: User
Fields: id, first_name, last_name, email, age, city
...
2. Test each route after implementation
...
def index():
    ...
    """
    # TODO: Write code to get all users from database
    # Hint: Use User.query.all()
    users = User.query.all()  # Replace this line with your implementation
    
    # TODO: Pass users to template
...
def add_user():
    ...
    if request.method == 'POST':
       ...
       # TODO: Create new user object
        # Hint: new_user = User(field1=value1, field2=value2, ...)
        new_user = User(first_name=first_name, last_name=last_name, email=email, age=int(age), city=city) 
    ...
    # TODO: Render add user form for GET request
...
def view_user(user_id):
    ...
    """
    # TODO: Get user by ID
    # Hint: Use User.query.get_or_404(user_id)
    user = User.query.get_or_404(user_id)  # Replace this line with your implementation
    
    # TODO: Pass user to template
...
def update_user(user_id):
    ...
    """
    # TODO: Get user by ID
    user = None  # Replace this line with your implementation
    ...
    if request.method == 'POST':
        ...
        # TODO: Update user object with new data
        # Hint: user.field_name = new_value
    ...
    # TODO: Render update form with current user data
...
def search_users():
    ...
    """
    # TODO: Get search query from request
    # Hint: request.args.get('query')
    query = request.args.get('query', '')
    
    # TODO: Search users
    # Hint: Use User.query.filter() with OR conditions
    users = []  # Replace this line with your implementation
